...
def rigid_body_motion_fluent(time_step,q, qdot, R, omega_ac_vec, delta_dot):
    ...
    file_name = f'../CFD/move_zone_wing_update_timestep{time_step+1}.dat'
    ...
    data = np.array(
        [[omega_e], [axis_e[0]], [axis_e[1]], [axis_e[2]], [origin_e[0]], [origin_e[1]], [origin_e[2]], [velocity_e[0]], [velocity_e[1]],
         [velocity_e[2]]])
    file_name = f'../CFD/move_zone_elevator_update_timestep{time_step+1}.dat'
    np.savetxt(file_name, data, fmt='%27.17e', header='', comments='')
    ...
    file_name = f'../CFD/move_zone_rudder_left_update_timestep{time_step+1}.dat'
    np.savetxt(file_name, data, fmt='%27.17e', header='', comments='')
    ...
    file_name = f'../CFD/move_zone_rudder_right_update_timestep{time_step+1}.dat'
    np.savetxt(file_name, data, fmt='%27.17e', header='', comments='')
    ...
    file_name = f'../CFD/move_zone_aileron_left_update_timestep{time_step+1}.dat'
    np.savetxt(file_name, data, fmt='%27.17e', header='', comments='')
    ...
    file_name = f'../CFD/move_zone_aileron_right_update_timestep{time_step+1}.dat'
    np.savetxt(file_name, data, fmt='%27.17e', header='', comments='')
